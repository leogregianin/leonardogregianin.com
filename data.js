const siteData = {
  ...
  "libraries": [
    ...
    },
    {
      "title": "ACBr",
      "tag": "Pascal, Delphi",
      "description": "Biblioteca para automação de tarefas fiscais e contábeis em Delphi, fornecendo componentes e funções para integração com sistemas de emissão de notas fiscais, boletos e outros serviços.",
